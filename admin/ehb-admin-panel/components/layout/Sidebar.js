...
const Sidebar = ({ collapsed }) => {
  ...
  const { workspaceSettings, toggleSidebar } = useWorkspace();
  ...
  const navigationItems = [
    ...
    },
    {
      ...
      subItems: [
        ...
        { name: 'User Analytics', href: '/dashboard/analytics/users' },
        { name: 'System Performance', href: '/dashboard/analytics/system' },
        { name: 'Business Metrics', href: '/dashboard/analytics/business' },
    ...
    },
    {
      ...
      subItems: [
        ...
        { name: 'Backup', href: '/dashboard/system/backup' },
      ],
    },
  ];
      ...
      {isExpanded && (
        <div className="absolute bottom-0 w-full p-4 border-t border-gray-200">
          <div className="text-xs text-gray-500">
            <div>EHB Admin Panel v1.0.0</div>
